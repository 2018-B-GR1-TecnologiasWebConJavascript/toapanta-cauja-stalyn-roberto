...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var registroUsuario, e_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, registrarse()];
                case 1:
                    registroUsuario = _a.sent();
                    console.log(registroUsuario);
                    return [3 /*break*/, 3];
                case 2:
                    e_1 = _a.sent();
                    console.log('Error al cargar el programa', e_1.message);
                    return [3 /*break*/, 3];
...
function registrarse() {
    return new Promise(function (resolve, reject) {
        fs.readFile('data.json', 'utf-8', function (err, contenido) {
            if (!err) {
                var types = JSON.parse(contenido);
                var typesObservable = rxjs.of(types);
                typesObservable
